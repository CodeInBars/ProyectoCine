      ...
      for (int i=0;i<filas;i++){
        ...
        //    controlador2.setIdPelicula(tit);
            ventana.show();
                          ...
                          // CS.setIdPelicula(tit);
                         // CS.lbTitulo.setText(tit);
                          //     CS.setCnx(cnx);
              //            Parent root = FXMLLoader.load(getClass().getResource("/vista/FXMLSeleccionarSesion.fxml"));
                       /*    Parent root  = FXMLLoader.load(getClass().getResource("/vista/FXMLSeleccionarSesion.fxml"));
                          ...
                          stage.setTitle("Seleccionar sesión");
